...
## Excel Calculations ##
Case-control likelihood ratio calculations can also be performed by the user, using the pre-formatted excel calculator "ccLRCalculator.xlsx" included in the GitHub repository. In case of missing ages the alternative tabulated format "ccLRCalculator_TabulatedFormat.xlsx" can be utilized by the user.
