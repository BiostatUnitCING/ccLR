...
## General information ##
This method was developed on behalf of the [Breast Cancer Association Consortium](https://bcac.ccge.medschl.cam.ac.uk/) (BCAC) and the [Evidence-based Network for the Interpretation of Germline Mutant Alleles](https://enigmaconsortium.org/) (ENIGMA) consortiums for the calculation of the case-control likelihood ratio (LR) for *BRCA1*, *BRCA2* and other disease-genes with well-established penetrance estimates.
